<x-admin-layout>
  ...
  <div class="py-12">
      <div class="mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex mt-5">
            <a href="{{ route('admin.menus.index') }}" class="px-4 py-2 bg-indigo-300 hover:bg-indigo-400">< Back</a>
          </div>
                ...
                <input 
                  ...
                  class="
                    ...
                    <div class="flex justify-end">
                      <button type="submit" class="px-4 py-2 bg-fuchsia-300 hover:bg-fuchsia-400 mt-5">Create Menu</button>
                    </div>
              </form>
            </div>

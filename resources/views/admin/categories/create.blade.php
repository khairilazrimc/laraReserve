<x-admin-layout>
  ...
  <div class="py-2">
      <div class="mx-auto sm:px-6 lg:px-8">
          ...
          <div class="flex mt-5">
            <a href="{{ route('admin.categories.index') }}" class="px-4 py-2 bg-white hover:bg-gray-300">< Back</a>
          </div>
            ...
            <div class="p-5 mb-3 w-full">
              <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                ...
                <div class="flex justify-end">
                  <button type="submit" class="px-4 py-2 bg-white hover:bg-emerald-300 mt-5 border">Create Category</button>
                </div>
              </form>
            </div>        
          </div>
